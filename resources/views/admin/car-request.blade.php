...
<section class="b-pageHeader">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $value->hire_cost }}</td>
				<td><form  action="{{ route('car.owner.approve') }}" method="post" onsubmit="return confirm('Do you really want to approve this car ?');">
					{{ csrf_field() }}
